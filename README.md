...
<p align="center">
  ...
  <a href="https://github.com/metago-ai/metagolifeform/releases/tag/v36.7.5">📦 Release v36.7.5</a> ·
...
<p align="center">
  ...
  <a href="https://github.com/metago-ai/metagolifeform/releases"><img alt="Release" src="https://img.shields.io/badge/Release-v36.7.5-blue"></a>
  <a href="https://unpkg.com/metago-lifeform/LICENSE"><img alt="License" src="https://img.shields.io/badge/License-MIT-green"></a>
  ...
  <a href="https://gitee.com/metago/metagolifeform/tree/main/packages/mcp-server"><img alt="MCP Server" src="https://img.shields.io/badge/MCP_Server-42_tools_+_8_prompts-8A2BE2?logo=npm"></a>
</p>
...
**🔗 仓库目录**：[packages/mcp-server/](https://gitee.com/metago/metagolifeform/tree/main/packages/mcp-server)
...
> 提示：若已全局安装，可使用 `"command": "metago-mcp-server"` 并省略 args。完整 22 个 tools 与 8 个 prompts 列表见 [packages/mcp-server/README.md](https://gitee.com/metago/metagolifeform/blob/main/packages/mcp-server/README.md)。
...
详见 [packages/dev-kit/README.md](https://gitee.com/metago/metagolifeform/blob/main/packages/dev-kit/README.md) 和 [产品矩阵战略规划](https://gitee.com/metago/metagolifeform/blob/main/docs/STRATEGY.md)。
...
| 产品 | 描述 | npm 包 | 仓库 |
|------|------|--------|------|
| **MetaGO Dev Kit** | 开发者增强包（4复用+4新增技能） | [`@metago-ai/dev-kit@1.0.5`](https://www.npmjs.com/package/@metago-ai/dev-kit) | [Gitee](https://gitee.com/metago/metago-dev-kit) · [GitHub](https://github.com/metago-ai/metago-dev-kit) |

### 产品线 B：平台工具

| 产品 | 描述 | npm 包 | 仓库 |
|------|------|--------|------|
| **MetaGO MCP Server** | 42 tools + 8 prompts 的 MCP 服务 | [`@metago-ai/mcp-server`](https://www.npmjs.com/package/@metago-ai/mcp-server) | [packages/mcp-server/](https://gitee.com/metago/metagolifeform/tree/main/packages/mcp-server) |
...
| **MetaGO Certify** | 6 项检查技能认证体系（Gold/Silver） | [`@metago-ai/certify@1.0.3`](https://www.npmjs.com/package/@metago-ai/certify) | [Gitee](https://gitee.com/metago/certify) · [GitHub](https://github.com/metago-ai/certify) |
| **MetaGO Engine** | 元构全息智能引擎核心本体（公理+协议+125引擎+验证器） | [`@metago-ai/engine@1.0.2`](https://www.npmjs.com/package/@metago-ai/engine) | [packages/engine/](https://gitee.com/metago/metagolifeform/tree/main/packages/engine) |

> 完整战略规划详见 [产品矩阵战略规划](https://gitee.com/metago/metagolifeform/blob/main/docs/STRATEGY.md) · 执行进度详见 [战略执行追踪日志](https://gitee.com/metago/metagolifeform/blob/main/docs/STRATEGY-EXECUTION-LOG.md)
...
- [元构白皮书](https://gitee.com/metago/metagolifeform/blob/main/docs/WHITEPAPER.md) · [Whitepaper](https://gitee.com/metago/metagolifeform/blob/main/docs/WHITEPAPER.md) — 智能生命体范式全貌描述（中英双语 8 章）
- [快速开始](https://gitee.com/metago/metagolifeform/blob/main/docs/GETTING_STARTED.md)
- [架构说明](https://gitee.com/metago/metagolifeform/blob/main/docs/ARCHITECTURE.md)
- [自定义指南](https://gitee.com/metago/metagolifeform/blob/main/docs/CUSTOMIZATION.md)
- [产品需求文档](https://gitee.com/metago/metagolifeform/blob/main/docs/PRD.md)
- [MCP Server 文档](https://gitee.com/metago/metagolifeform/blob/main/docs/MCP_SERVER.md)
- [产品矩阵战略规划](https://gitee.com/metago/metagolifeform/blob/main/docs/STRATEGY.md)
- [战略执行追踪日志](https://gitee.com/metago/metagolifeform/blob/main/docs/STRATEGY-EXECUTION-LOG.md)
- [诞生宣言（中文）](https://gitee.com/metago/metagolifeform/blob/main/MANIFESTO.md) · [Birth Manifesto (English)](https://gitee.com/metago/metagolifeform/blob/main/MANIFESTO_EN.md)

---

## 许可证

MIT License - 详见 [LICENSE](https://unpkg.com/metago-lifeform/LICENSE)
