...
<p align="center">
  ...
  <a href="https://github.com/metago-ai/metagolifeform/releases"><img alt="Release" src="https://img.shields.io/badge/Release-v36.4.12-blue"></a>
...
| 产品 | 描述 | npm 包 | 仓库 |
|------|------|--------|------|
| **MetaGO Skills SDK** | TypeScript SDK，开发自定义元构技能 | [`@metago-ai/skills-sdk@1.0.2`](https://www.npmjs.com/package/@metago-ai/skills-sdk) | [Gitee](https://gitee.com/metago/metago-skills-sdk) · [GitHub](https://github.com/metago-ai/metago-skills-sdk) |
| **MetaGO Skills Hub** | 技能市场，浏览/搜索/发现技能 | Web 应用 | [Gitee](https://gitee.com/metago/metago-skills-hub) · [GitHub](https://github.com/metago-ai/metago-skills-hub) |
| **MetaGO Certify** | 6 项检查技能认证体系（Gold/Silver） | [`@metago-ai/certify@1.0.1`](https://www.npmjs.com/package/@metago-ai/certify) | [Gitee](https://gitee.com/metago/metago-certify) · [GitHub](https://github.com/metago-ai/metago-certify) |
