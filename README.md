...
<p align="center">
  ...
  <a href="https://github.com/metago-ai/metagolifeform/releases/tag/v36.7.7">📦 Release v36.7.7</a> ·
...
<p align="center">
  ...
  <a href="https://github.com/metago-ai/metagolifeform/releases"><img alt="Release" src="https://img.shields.io/badge/Release-v36.7.7-blue"></a>
...
> **一句话描述**：把元构超级智能生命体的 35 项能力封装为 MCP tools，8 条引导词封装为 MCP prompts，任何支持 MCP 协议的客户端（Claude Desktop / Cursor / Trae 等）一次配置即开即用。
...
| 产品 | 描述 | npm 包 | 仓库 |
|------|------|--------|------|
| **MetaGO MCP Server** | 35 tools + 8 prompts 的 MCP 服务 | [`@metago-ai/mcp-server`](https://www.npmjs.com/package/@metago-ai/mcp-server) | [packages/mcp-server/](packages/mcp-server/) |
...
| **MetaGO Certify** | 6 项检查技能认证体系（Gold/Silver） | [`@metago-ai/certify@1.0.4`](https://www.npmjs.com/package/@metago-ai/certify) | [Gitee](https://gitee.com/metago/certify) · [GitHub](https://github.com/metago-ai/certify) |
| **MetaGO Engine** | 元构全息智能引擎核心本体（公理+协议+125引擎+验证器） | [`@metago-ai/engine@1.0.3`](https://www.npmjs.com/package/@metago-ai/engine) | [packages/engine/](packages/engine/) |
...
- [元构白皮书](docs/WHITEPAPER.md) · [Whitepaper](docs/WHITEPAPER.md) — 智能生命体范式全貌描述（中英双语 8 章）
...
- [战略路线图 v2.1](docs/STRATEGY-ROADMAP-V36.7.8.md)
