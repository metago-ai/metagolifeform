...
39 技能中，22 个被封装为 MCP tools（结构化参数），加上 20 个独有思维工具，7 个同名工具在 MCP 中合并（TOOLKIT_TOOLS 优先），加上 2 个工程质量族工具，共 37 tools（公式：22 + 20 - 7 + 2 = 37）。
...
- [MCP Server 37 tools](../api/mcp-server) — 通过 MCP 协议调用
