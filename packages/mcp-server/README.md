...
| 产品 | 描述 | npm 包 | 仓库 |
|------|------|--------|------|
| **MetaGO MCP Server** | 37 tools + 8 prompts 的 MCP 服务 | [`@metago-ai/mcp-server`](https://www.npmjs.com/package/@metago-ai/mcp-server) | [Gitee](https://gitee.com/metago/metagolifeform/tree/main/packages/mcp-server) · [GitHub](https://github.com/metago-ai/metagolifeform/tree/main/packages/mcp-server) |
...
| **MetaGO Certify** | 6 项检查技能认证体系（Gold/Silver） | [`@metago-ai/certify@1.0.5`](https://www.npmjs.com/package/@metago-ai/certify) | [Gitee](https://gitee.com/metago/certify) · [GitHub](https://github.com/metago-ai/metagolifeform) |
| **MetaGO Engine** | 元构全息智能引擎核心本体（公理+属性+协议+125引擎+验证器） | [`@metago-ai/engine@1.0.6`](https://www.npmjs.com/package/@metago-ai/engine) | [packages/engine/](packages/engine/) |
