...
| 产品 | 描述 | npm 包 | 仓库 |
|------|------|--------|------|
| **MetaGO MCP Server** | 42 tools + 8 prompts 的 MCP 服务 | [`@metago-ai/mcp-server`](https://www.npmjs.com/package/@metago-ai/mcp-server) | [Gitee](https://gitee.com/metago/metagolifeform/tree/main/packages/mcp-server) · [GitHub](https://github.com/metago-ai/metagolifeform/tree/main/packages/mcp-server) |
